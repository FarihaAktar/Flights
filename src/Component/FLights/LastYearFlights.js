...
import { lastYearData } from '../../Redux/rootSlice';

const LastYearFlights = () => {

    const lastFlights = useSelector(lastYearData);
...
export default LastYearFlights
